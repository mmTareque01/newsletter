...
const WRITE_NO_INCLUDE_SELECT_FIELDS_REGEX = /createMany|updateMany|deleteMany|updateManyAndReturn|createManyAndReturn/;
class ExtendedDMMFSchemaField extends formattedNames_1.FormattedNames {
    ...
    _setMatchedPrismaAction() {
        var _a;
        const matched = objectMaps_1.PRISMA_ACTION_MATCHER_ARRAY.find(([matcher]) => {
            return matcher.every((match) => this.name.includes(match));
        });
        return {
            action: matched === null || matched === void 0 ? void 0 : matched[1],
            primitive: (_a = matched === null || matched === void 0 ? void 0 : matched[0]) !== null && _a !== void 0 ? _a : [],
        };
    }
    _setModelType() {
        return this.prismaAction.primitive.reduce((acc, curr) => acc.replace(curr, ''), this.name);
    }
    _setArgName() {
        var _a;
        const argName = objectMaps_1.PRISMA_ACTION_ARG_MAP[(_a = this.prismaAction) === null || _a === void 0 ? void 0 : _a.action];
        if (!argName)
            return;
