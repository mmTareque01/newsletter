...
const writeOutputObjectType = ({ fileWriter, dmmf, getSingleFileContent = false }, field) => {
    ...
    writer
        ...
        writer
            ...
            .conditionalWriteLine(field.writeIncludeArg && !useMultipleFiles, `include: ${field.modelType}IncludeSchema.optional(),`)
            .conditionalWriteLine(field.writeIncludeArg && useMultipleFiles, `include: z.lazy(() => ${field.modelType}IncludeSchema).optional(),`);
